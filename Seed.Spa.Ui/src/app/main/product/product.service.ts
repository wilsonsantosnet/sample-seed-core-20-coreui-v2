...
export class ProductService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: ProductServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('Product', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('Product').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Product').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Product').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if ( model.productId != undefined) {
            return this.api.setResource('Product').put(model);
        }

        return this.api.setResource('Product').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('Product').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('Product').export(filters);
    }
}
