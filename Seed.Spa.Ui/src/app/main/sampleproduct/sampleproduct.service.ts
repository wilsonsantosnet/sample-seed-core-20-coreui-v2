...
@Injectable()
export class SampleProductService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: SampleProductServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('SampleProduct', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('SampleProduct').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('SampleProduct').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('SampleProduct').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if ( model.sampleId != undefined ||  model.productId != undefined) {
            return this.api.setResource('SampleProduct').put(model);
        }

        return this.api.setResource('SampleProduct').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('SampleProduct').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('SampleProduct').export(filters);
    }
}
