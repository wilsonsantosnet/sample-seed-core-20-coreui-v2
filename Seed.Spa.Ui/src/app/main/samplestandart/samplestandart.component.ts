...
@Component({
    selector: 'app-samplestandart',
    templateUrl: './samplestandart.component.html',
    styleUrls: ['./samplestandart.component.css'],
})
export class SampleStandartComponent extends ComponentBase implements OnInit, OnDestroy {
    ...
    constructor(private sampleStandartService: SampleStandartService, private router: Router, private ref: ChangeDetectorRef) {
    ...
    ngOnInit() {
        ...
        this.sampleStandartService.OnHide(this.saveModal, this.editModal, () => { this.hideComponents() });

        this.sampleStandartService.get(this.vm.modelFilter).subscribe((result) => {
        ...
        if (this._navigatioModal)
            LocationHistoryService.saveLocal("samplestandart");
    ...
    updateCulture(culture: string = null)
    {
        ...
        this.sampleStandartService.updateCultureMain(culture).then((infos: any) => {
    ...
    public onFilter(modelFilter: any) {
        ...
        this.sampleStandartService.get(modelFilter).subscribe((result) => {
            this.vm.filterResult = result.dataList;
            this.vm.summary = result.summary;
    ...
    public onExport() {
        this.sampleStandartService.export().subscribe((result) => {
    ...
    public onCreate() {
        ...
        this.navigateStrategy(this.saveModal, this.router, "/samplestandart/create");
    }
    ...
    public onEdit(model: any) {
        ...
        if (model)  {
            newModel = { id: model.sampleStandartId }
        }

        if (!this._navigatioModal) {
            this.navigateStrategy(this.editModal, this.router, "/samplestandart/edit/" + newModel.id);
        }
        else {
            this.sampleStandartService.get(newModel).subscribe((result) => {
    ...
    public onSave(model: any) {
        ...
        this.sampleStandartService.save(model).subscribe((result) => {
            ...
            this.vm.filterResult = this.vm.filterResult.filter(function (model) {
                return  model.sampleStandartId != result.data.sampleStandartId;
            });
    ...
    public onDetails(model: any) {
        ...
        if (!this._navigatioModal) {
            this.navigateStrategy(this.editModal, this.router, "/samplestandart/details/" + newModel.id);
        }
        else {
            this.sampleStandartService.get(newModel).subscribe((result) => {
    ...
    public onPrint(model: any) {
        this.router.navigate(['/samplestandart/print', model.sampleStandartId]);
    }
    ...
    public onDeleteConfimation(model: any) {
        ...
        var conf = GlobalService.operationExecutedParameters(
            ...
            () => {
                ...
                this.sampleStandartService.delete(newModel).subscribe((result) => {
                    this.vm.filterResult = this.vm.filterResult.filter(function (model) {
                        return  model.sampleStandartId != result.data.sampleStandartId;
                    });
                    this.vm.summary.total = this.vm.filterResult.length
    ...
    public onPageChanged(pageConfig: any) {
        ...
        let modelFilter = this.sampleStandartService.pagingConfig(this.vm.modelFilter, pageConfig);
        this.sampleStandartService.get(modelFilter).subscribe((result) => {
            this.vm.filterResult = result.dataList;
            this.vm.summary = result.summary;
        });
    ...
    public onOrderBy(order: any) {
        ...
        let modelFilter = this.sampleStandartService.orderByConfig(this.vm.modelFilter, order);
        this.sampleStandartService.get(modelFilter).subscribe((result) => {
            this.vm.filterResult = result.dataList;
            this.vm.summary = result.summary;
        });
